...
API_DESCRIPTION = """
Enterprise-grade agentic auditing framework designed to detect,
investigate, and report retail fraud. Includes interfaces for
autonomous agents, transaction analysis, and ML fraud models.
"""
API_VERSION = "1.0.0"
